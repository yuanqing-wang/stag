...
def run(args):
    ...
    if args.stag.startswith("none") == False:
        ...
        dgl.function.sum = partial(stag.stag_sum_bernoulli_shared, alpha=args.alpha)
    elif args.stag == "none_gdc":
        dgl.function.sum = partial(stag.stag_sum_bernoulli, alpha=args.alpha)
    elif args.stag == "none_dropout":
        dgl.function.sum = partial(stag.stag_sum_dropout, alpha=args.alpha)
