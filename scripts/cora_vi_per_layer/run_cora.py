...
class Net(torch.nn.Module):
    def __init__(
        ...
        self.f_z_mu_first = torch.nn.Linear(2*hidden_features, 1)
        self.f_z_log_sigma_first = torch.nn.Linear(2*hidden_features, 1)
        ...
        [
            ...
            },
            {
                "params": itertools.chain(
                    ...
                    net.f_z_mu_first.parameters(),
                    net.f_z_log_sigma_first.parameters()
                ),
                "lr": args.lr_vi
            }
        ]
